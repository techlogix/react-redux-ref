...
var Counter = _react2.default.createClass({
    ...
    componentDidMount: function componentDidMount() {
        ...
        setInterval(function () {
            _this.setState({ count: 1 + _this.state.count });
        }, 1000);
    },
    render: function render() {
...
var _MainLayout = __webpack_require__(254);
...
var _PeopleProxy = __webpack_require__(255);

var _PeopleProxy2 = _interopRequireDefault(_PeopleProxy);
...
var Users = _react2.default.createClass({
    ...
    componentDidMount: function componentDidMount() {
        ...
        new _PeopleProxy2.default().getPeople().then(function (response) {
            console.log(response.data.results);
            _this.setState({ users: response.data.results });
        });
    },
    render: function render() {
...
var User = _react2.default.createClass({
    ...
    render: function render() {
        ...
        var activeText = this.state.active ? 'active' : 'inactive';
        return _react2.default.createElement(
            'div',
            { className: 'user' },
            _react2.default.createElement(
...
var Reactive = function Reactive() {
    return _react2.default.createElement(
        ...
        _react2.default.createElement("img", { style: "border: 0; position: fixed; right: 0; top:0; z-index: 9000",
...
var _Reactive = __webpack_require__(253);
...
var PeopleProxy = function () {
    function PeopleProxy() {
        _classCallCheck(this, PeopleProxy);
    }

    _createClass(PeopleProxy, [{
        key: 'getPeople',
        ...
        value: function getPerson(id) {
            return _axios2.default.get('http://swapi.co/api/person/' + id);
        }
    }]);
